...
class SP_News_thmb_Widget extends WP_Widget {
    ...
    function SP_News_thmb_Widget() {
        ...
        $widget_ops = array('classname' => 'SP_News_thmb_Widget', 'description' => __('Displayed Latest News Items Scrolling from the News  in a sidebar with thumbnails', 'news_cpt') );
        $control_ops = array( 'width' => 350, 'height' => 450, 'id_base' => 'sp_news_sthumb_widget' );
        $this->WP_Widget( 'sp_news_sthumb_widget', __('Latest News with thumb Scrolling', 'news_cpt'), $widget_ops, $control_ops );
    }
