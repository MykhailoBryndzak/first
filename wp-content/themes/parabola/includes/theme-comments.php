...
function parabola_comments_on() {
	if ( comments_open() && ! post_password_required() ) :
		...
		printf ( comments_popup_link( __( 'No comments', 'parabola' ), __( '<b>1</b> <span>Comment</span>', 'parabola' ), __( '<b>%</b> <span>Comments</span>', 'parabola' ),(''),__('<b>Comments off</b>','parabola') ));
		print '</div>';
	endif;
}
endif;
